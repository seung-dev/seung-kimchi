...
public enum SError {
	...
	, TOKEN_IS_INVALID("A201", "유효한 토큰이 아닙니다.")
	, TOKEN_IS_NOT_SECURE("A202", "Bad Token.")
	, TOKEN_IS_MALFORMED("A203", "Bad Token.")
	, TOKEN_IS_EXPIERED("A204", "토큰이 만료되었습니다.")
	, TOKEN_IS_UNSUPPORTED("A205", "Bad Token.")
